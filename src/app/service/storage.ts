...
const CLIENT_STORAGE = new InjectionToken<Storage>( 'Client Storage', {factory: () => localStorage} );
...
set = (key: string, value: string) => this.storage.setItem(key, typeof value === 'string' ? value : JSON.stringify(value));
